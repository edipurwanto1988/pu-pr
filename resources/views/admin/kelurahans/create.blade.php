...
<div class="max-w-lg">
    <div class="mb-6 flex items-center gap-2">
        ...
        <h1 class="text-2xl font-semibold text-gray-800"><i class="ri-add-circle-line mr-2"></i>Tambah Kelurahan</h1>
    </div>

    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.kelurahans.store') }}" method="POST">
            @csrf
            <div class="space-y-4">
                <div>
