...
<div class="max-w-lg">
    <div class="mb-6 flex items-center gap-2">
        ...
        <h1 class="text-2xl font-semibold text-gray-800"><i class="ri-edit-line mr-2"></i>Edit Kecamatan</h1>
    </div>
        ...
        <form action="{{ route('admin.kecamatans.update', $kecamatan) }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $kecamatan->name) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    @error('name')
