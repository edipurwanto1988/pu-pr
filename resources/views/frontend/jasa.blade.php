...
@section('title', 'Jasa — PUPR')

@section('og_title', 'Jasa UMKM/IKM — PUPR')
@section('og_description', 'Temukan jasa terbaik dari pelaku UMKM/IKM Kota Pekanbaru.')
@section('og_image', asset('logo_pupr.webp'))
@section('og_url', route('jasa'))
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-6">Jasa</h1>

    <form method="GET" action="{{ route('jasa') }}" class="mb-6 flex flex-wrap gap-4">
        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari jasa..." class="flex-1 min-w-[200px] px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
