<x-guest-layout>
    <h3 class="text-xl font-bold text-gray-800 text-center mb-1">Daftar Akun</h3>
    <p class="text-sm text-gray-500 text-center mb-6">Buat akun baru untuk mendaftarkan UMKM/IKM Anda</p>
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-gray-500">Sudah punya akun? <a href="{{ route('login') }}" class="font-medium text-blue-600 hover:text-blue-700 transition-colors">Masuk</a></p>
    </div>
</x-guest-layout>
